<div id="main">
    ...
    <section id="intro" class="main">
        <div class="spotlight">
            ...
            <img src="<?= base_url() ?>asset/images/surat.jpeg" class="landing" />
        </div>
    </section>
                    ...
                    <tbody>
                        ...
                        foreach ($skck as $key => $value) : ?>
                            <tr>
                                ...
                                <td> <a href="<?= base_url('Surat/view_surat_pdf/' . $value->id); ?>" class="btn btn-primary">Cetak Surat</a>
                                    <a href="<?= base_url('Surat/hapus/' . $value->id) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini ?')">HAPUS</a>
                                </td>
                            </tr>
