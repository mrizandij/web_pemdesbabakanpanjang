				...
				<div class="header-column">
					<div style="text-align: center;">
						...
						foreach ($logo->result_array() as $row) {
							echo "<img style='width:80px;' src='" . base_url() . "asset/logo/$row[gambar]'/>";
						}
						?>
						<h4><b><span style="color: #fff;">
									<?php
									...
									?>
									<?php echo $web['nama_website']; ?></span></b></h4>
						<h4><b><span style=" color: #fff;"><?php echo $web['alamat']; ?> </span></b></h4>
					</div>
				</div>
			...
			<div class="header-nav-main header-nav-main-light header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse" style="padding-top:3px;">
				<nav>
					<ul class="nav nav-pills" id="mainNav">
						...
						<li>
							<a href="<?php echo base_url(); ?>surat/tambah_data" target=" _blank">
								Pelayanan Surat
							</a>
						</li>
