...
class Administrator extends CI_Controller
{
    ...
    function identitaswebsite()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $config['allowed_types'] = 'gif|jpg|png|ico|PNG|JPEG|JPG';
            ...
            if ($hasil['file_name'] == '') {
                $data = array(
                    ...
                    'alamat' => $this->db->escape_str($this->input->post('a2')),
    ...
    function tambah_download()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $config['allowed_types'] = 'gif|jpg|png|zip|rar|pdf|doc|docx|ppt|pptx|xls|xlsx|txt|PNG|jpeg';
